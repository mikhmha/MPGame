...
Also I think it'd be effective from an advertising perspective. Say that someone stumbles upon the site, and ends up playing as the DM a few times. If they get some entertainment out if it maybe that encourages them to download the game on steam to experience the other half of the game?
